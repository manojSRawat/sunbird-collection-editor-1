...
export class HeaderComponent implements OnDestroy, OnInit {
  ...
  async handleActionButtons() {
    this.visibility = {};
    this.visibility.editContent = this.editorService.editorMode === 'edit' || (this.editorService.editorMode === 'orgreview' && this.editorService.isReviewerEditEnable);
    this.visibility.saveContent = this.editorService.editorMode === 'edit' || (this.editorService.editorMode === 'orgreview' && this.editorService.isReviewerEditEnable);
